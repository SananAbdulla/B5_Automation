     ...
     */
        ...
        if(actualPlaceholderForFirstname.equals(LoopCampConstants.EXPECTED_PLACEHOLDER_FOR_FIRSTNAME)){
            System.out.println("expected placeholder for form: \""
                    + LoopCampConstants.EXPECTED_PLACEHOLDER_FOR_FIRSTNAME + "\", matches actual placeholder: \"" + actualPlaceholderForFirstname + "\" => TEST PASS");
        } else {
            System.out.println("expected placeholder for form: \""
                    + LoopCampConstants.EXPECTED_PLACEHOLDER_FOR_FIRSTNAME + "\", DOES NOT match actual placeholder: \"" + actualPlaceholderForFirstname + "\" => TEST FAIL");
        }
    }
}
